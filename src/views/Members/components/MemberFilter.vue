...
const resetForm = () => {
  ...
  formFilter.sortBy = 'created_time'
  formFilter.minBalance = null
  formFilter.maxBalance = null
    ...
    <el-form :model="formFilter" :rules="rules" ref="formRef">
      ...
      <el-form-item label="排序依据" class="radio-groups">
        <el-radio-group v-model="formFilter.sortBy" class="sort-options">
          <el-radio-button value="created_time">创建时间</el-radio-button>
      ...
      <el-form-item label="余额区间">
        <el-input-number v-model="formFilter.minBalance" placeholder="最小余额" :min="0" />
        <span style="margin: 0 8px">-</span>
        <el-input-number v-model="formFilter.maxBalance" placeholder="最大余额" :min="0" />
      </el-form-item>
