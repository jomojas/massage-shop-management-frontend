...
watch(
  ...
  (val) => {
    if (val) {
      Object.assign(formEditProject, val)
    }
  },
  { immediate: true },
)
...
const resetForm = () => {
  formEditProject.name = ''
  formEditProject.category = ''
  formEditProject.priceGuest = null
  formEditProject.priceMember = null
  formEditProject.description = ''
}
const handleCancel = () => {
  resetForm()
  ...
  >
    ...
    >
      <el-form-item label="项目名称" prop="name">
        <el-input v-model="formEditProject.name" placeholder="输入项目名称" />
      </el-form-item>
      <el-form-item label="项目类别" prop="category">
        <el-select v-model="formEditProject.category" placeholder="请选择类别" filterable>
          <el-option v-for="item in props.categories" :key="item" :label="item" :value="item" />
        </el-select>
      </el-form-item>
      <el-form-item label="客人价" prop="priceGuest">
        <el-input-number
          v-model="formEditProject.priceGuest"
          :min="0"
          :step="1"
          :precision="2"
          placeholder="输入客人价"
      ...
      <el-form-item label="会员价" prop="priceMember">
        <el-input-number
          v-model="formEditProject.priceMember"
          :min="0"
          :step="1"
          :precision="2"
          placeholder="输入会员价"
      ...
      <el-form-item label="描述" prop="description">
        <el-input
          v-model="formEditProject.description"
          type="textarea"
          placeholder="项目描述（可选）"
        />
      </el-form-item>
